#!/usr/bin/env python3
"""
Пример использования системы подсчета ошибок
...
def simulate_command_execution(command: str, should_fail: bool = False) -> CommandResult:
...
def main():
    ...
    print("=== Пример системы подсчета ошибок ===\n")
    
    # Создаем логгер
    logger = StructuredLogger("ErrorTrackingExample")
